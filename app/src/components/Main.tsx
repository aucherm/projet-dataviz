...
export function Main() {
  return (
    <main className="bg-white/60 max-w-7xl mx-auto text-center px-20 py-30 rounded-md text-black ">
      <h1 className="font-bold text-4xl">Paris Movie Tracker</h1>
      <p className="font-bold px-10 py-8">
      ...
      <NavLink
        to="/Analyse"
        className="{({ isActive }) =>
      font-semibold px-4 py-2 rounded-lg bg-white hover:bg-black mt-6 hover:text-white inline-block"
      >
